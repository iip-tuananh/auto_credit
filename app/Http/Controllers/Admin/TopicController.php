...
class TopicController extends Controller
{
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->addColumn('questions', function ($obj) {
                ...
                $txt = number_format($c) . ' ' . Str::plural('question', $c);
                $url = route('questions.index').'?topic='.$obj->id;

                return '<a href="'.e($url).'" class="badge '.$cls.' badge-pill" target="_blank" style="font-size:13px;padding:.45rem .75rem" title="View '.e($txt).'">'.e($txt).'</a>';
            })
            ...
            ->addIndexColumn()
            ->rawColumns(['link', 'action', 'image', 'questions'])
            ->make(true);
    }
