    ...
    <div class="col-lg-8">
        <div class="custom-card">
            ...
            <div class="form-group mb-4">
                <label class="form-label">Tiêu đề dẫn</label>
                <input type="text" class="form-control" ng-model="form.sub_title">
            ...
            <div class="form-group mb-4">
                ...
                <textarea rows="8" class="form-control" ng-model="form.intro"></textarea>
