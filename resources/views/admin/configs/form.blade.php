...
{{--                    <input class="form-control" ng-model="form.nganhang" type="text">--}}
{{--                </div>--}}

{{--                <div class="form-group custom-group">--}}
{{--                    <label class="form-label">Chủ tài khoản</label>--}}
{{--                    <input class="form-control" ng-model="form.chutaikhoan" type="text">--}}
{{--                </div>--}}
...
{{--                    <input class="form-control" ng-model="form.chinhanh" type="text">--}}
{{--                </div>--}}
...
{{--				</div>--}}
			...
			<div class="col-md-4 col-xs-12">
                ...
                <div class="form-group text-center mb-4">
                    <label class="form-label required-label">Logo 2</label>
                    <div class="main-img-preview">
