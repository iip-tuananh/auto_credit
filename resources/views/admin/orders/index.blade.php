...
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '/admin/loan-applications/searchData',
        ...
        columns: [
            ...
            {data: 'code', title: 'Mã hồ sơ'},
            {data: 'customer', title: 'Khách hàng'},
            {data: 'vehicle_type', title: 'Loại phương tiện chọn'},
            {data: 'borrow_amount', title: 'Khoản vay dự kiến', className: "text-center"},
            {data: 'status', title: 'Trạng thái', className: "text-center"},
            {data: 'created_at', title: 'Ngày tạo'},
            {data: 'action', orderable: false, title: "Hành động"}
        ],
        search_columns: [
            {data: 'code', search_type: "text", placeholder: "Mã hồ sơ"},
        ],
    }).datatable;
