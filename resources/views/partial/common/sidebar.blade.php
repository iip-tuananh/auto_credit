...
|| request()->is('admin/abouts') || request()->is('admin/abouts/*')  || request()->is('admin/getting-started')
 ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('achievements.index') }}" class="nav-link {{ Request::routeIs('achievements.index') ? 'active' : '' }}">
                            ...
                            <p>Khối "Các bước sử dụng dịch vụ"</p>
                        </a>
                    </li>
...
{{--                    </li>--}}
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/topic') || request()->is('admin/topic/*') || request()->is('admin/topic') || request()->is('admin/topic/*') || request()->is('admin/questions') || request()->is('admin/questions/*')? 'menu-open' : '' }} ">
...
{{--            </li>--}}
      ...
      request()->is('admin/loan-applications*') ||
      request()->is('admin/customers*')
        ...
        : ''
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/reviews') ||  request()->is('admin/banner-page')
||  request()->is('admin/banners') || request()->is('admin/origins') || request()->is('admin/contacts') || request()->is('admin/banner') || request()->is('admin/policies')
|| request()->is('admin/partners') ? 'menu-open' : '' }} ">
